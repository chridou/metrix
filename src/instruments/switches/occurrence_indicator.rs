...
impl OccurrenceIndicator {
    pub fn new<T: Into<String>>(name: T) -> OccurrenceIndicator {
        OccurrenceIndicator {
            name: name.into(),
            title: None,
            description: None,
    ...
    pub fn if_happened_within(mut self, d: Duration) -> Self {
        self.set_if_happened_within(d);
        self
    }

    pub fn get_if_happened_within(&self) -> Duration {
